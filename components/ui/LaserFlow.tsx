...
// Three.js removed - CSS-based fallback animation
type Props = {
  className?: string;
  style?: React.CSSProperties;
  color?: string;
  [key: string]: any; // Accept other props for backwards compatibility
};
...
export const LaserFlow: React.FC<Props> = ({
  ...
  // CSS-based fallback animation (Three.js removed for bundle size)
  return (
    <div 
      ref={useRef<HTMLDivElement | null>(null)} 
      className={`w-full h-full relative ${className || ''}`} 
